...
domToMutation: function(xmlElement) {
    ...
    Cpp.forBlock['define_vector'] = function(block) {
...
Blockly.Blocks['vector_assign'] = {  
    ...
    Cpp.forBlock['vector_assign'] = function(block){
...
function bitwise_generateCode(block, operator) {
    ...
    // pointer 
    Cpp.forBlock['nullptr'] = function() {
        return ['nullptr', 1];
    };

    Cpp.forBlock['define_pointer'] = function(block) {
        ...
        var var_name = Cpp.nameDB_.getName(block.getFieldValue('var_name'), Blockly.VARIABLE_CATEGORY_NAME);
        var value = Cpp.valueToCode(block, 'value', 1) || '';
        code = '';
    ...
    Cpp.forBlock['define_reference'] = function(block) {
    ...
    Cpp.forBlock['def_ptr'] = function(block) {
        var Const_ptr = block.getFieldValue('const_ptr');
        var Const_var = block.getFieldValue('const_var');
        var unsigned = block.getFieldValue('unsigned');
        var type = Cpp.valueToCode(block, 'TYPE', 1) || 'int';
    ...
    Cpp.forBlock['def_ref'] = function(block) {
        var Const_ptr = block.getFieldValue('const');
        var unsigned = block.getFieldValue('unsigned');
        var type = Cpp.valueToCode(block, 'TYPE', 1) || 'int';
        var var_name = block.getFieldValue('var_name');
    ...
    Cpp.forBlock['ptr_equal'] = function(block) {
        var ptr = block.getFieldValue('ptr_name');
        var value = Cpp.valueToCode(block, 'VALUE', 1) || '0';
        if (value.startsWith('(') && value.endsWith(')')) {
            value = value.slice(1, -1);
        }
        return `${ptr} = ${value};\n`;
    ...
    Cpp.forBlock['get_ptr'] = function(block) {
        var ptr = block.getFieldValue('ptr_name');
        return [`${ptr}`, 1];
    };

    Cpp.forBlock['ref_equal'] = function(block) {
    ...
    Cpp.forBlock['get_ref'] = function(block) {
        var ref = block.getFieldValue('ref_name');
        return [`${ref}`, 1];
    };

    Cpp.forBlock['ptr_of'] = function(block) {
        var ptr_name = block.getFieldValue('ptr_name');
        var of = Cpp.valueToCode(block, 'of', 1);
        return `${ptr_name} -> ${of}\n`;
    };

    Cpp.forBlock['ptr_to'] = function(block) {
        var var_name = block.getFieldValue('var_name');
        return [`*${var_name}`, 1];
    };

    Cpp.forBlock['ref_to'] = function(block) {
        var var_name = block.getFieldValue('var_name');
        return [`&${var_name}`, 1];
    };

    Cpp.forBlock['delete_block'] = function(block){
    ...
    // define variable
    Cpp.forBlock['define_variable'] = function(block) {
    ...
    Cpp.forBlock['var_equal'] = function(block) {
    ...
    Cpp.forBlock['get_var'] = function(block) {
        var variable = block.getFieldValue('VAR_NAME');
        return [`${variable}`, 1];
    };
    ...
    // vector
    Cpp.forBlock['vector_push_back'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
    ...
    Cpp.forBlock['vector_emplace_back'] = function(block) {
        var name = block.getFieldValue('NAME');
        var num = block.getFieldValue('number');
        return code = name + ".emplace_back(" + num + ");\n";
    };
    
    Cpp.forBlock['vector_append_range'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
    ...
    Cpp.forBlock['vector_pop_back'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
        return vector_name + ".pop_back();\n";
    };
    
    Cpp.forBlock['vector_insert'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
    ...
    Cpp.forBlock['vector_insert_range'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
        var pos = Cpp.valueToCode(block, 'pos', 1) | '0';
    ...
    Cpp.forBlock['vector_erase'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
    ...
    Cpp.forBlock['vector_swap'] = function(block) {
    ...
    Cpp.forBlock['vector_operate[]'] = function(block){
        var vector_name = block.getFieldValue('vector_name');
        var pos = Cpp.valueToCode(block, 'pos', 1);
        if (pos.startsWith('(') && pos.endsWith(')')) {
            pos = pos.slice(1, -1);
    ...
    Cpp.forBlock['vector_front'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
        return [`${vector_name}.front()`, 1];
    }
    
    Cpp.forBlock['vector_back'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
        return [`${vector_name}.back()`, 1];
    };
    
    Cpp.forBlock['vector_clear'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
        return vector_name + ".clear()";
    };
    
    Cpp.forBlock['vector_size'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
        return [`${vector_name}.size()`, 1];
    }
    
    Cpp.forBlock['vector_empty'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
        return [`${vector_name}.empty()`, 1];
    }
    
    Cpp.forBlock['vector_reserve'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
        return [`${vector_name}.reserve()`, 1];
    }
    
    Cpp.forBlock['vector_capacity'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
        return [`${vector_name}.capacity()`, 1];
    }
    
    Cpp.forBlock['vector_max_size'] = function(block) {
        var vector_name = block.getFieldValue('vector_name');
        return [`${vector_name}.max_size()`, 1];
    }
    
    Cpp.forBlock['vector_begin'] = function(block) {
        var vector_name = block.getFieldValue('vector_name') || '';
        return [`${vector_name}.begin()`, 1];
    }
    
    Cpp.forBlock['vector_end'] = function(block) {
        var vector_name = block.getFieldValue('vector_name') || '';
        return [`${vector_name}.end()`, 1];
    }
    
    Cpp.forBlock['vector_rbegin'] = function(block) {
        var vector_name = block.getFieldValue('vector_name') || '';
        return [`${vector_name}.rbegin()`, 1];
    }
    
    Cpp.forBlock['vector_rend'] = function(block) {
        var vector_name = block.getFieldValue('vector_name') || '';
